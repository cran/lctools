...
```{r}
spGini.Sim100<-mc.spGini(Nsim=99,bw,myDF.new[,1],myDF.new[,2],myDF.new[,3],wt)
spGini.Sim100$pseudo.p
```
Since the pseudo p-value is 0.01 for 99 permutations, it can be argued that the terms of the spatial Gini coefficient are significant at the 99% level. This of course could be increased if more permutations are tested (eg 999).
