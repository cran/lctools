moransI.w<-function(x,w){
  ...
  Results<-list(Morans.I=moran, Expected.I=E.I, z.resampling=Z.I.resampling,z.randomization=Z.I.randomization, p.value.resampling=pv.resampling,p.value.randomization=pv.randomization)
